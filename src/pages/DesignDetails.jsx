    ...
    return(
        ...
        <div className="design-details">
            <div key={design.id} className="item">
                    ...
                    md:grid-cols-2 md:gap-14 md:mx-32 md:mt-16 md:mb-14">
                        ...
                        <div className="hidden md:flex justify-between" style={{ width: 'calc(100% - 14px)' }}>
                        ...
                        <div className="mx-6" >
                    <h1 className="text uppercase text-left text-xl mb-2 mt-4 font-semibold
                    md:text-3xl ">{design.title}</h1>
                    {/* <h2 className="text text-left text-xl">
                    {isSold ? "sold" : `${painting.price} €`}</h2> */}
                    <p className="text text-left 
                    md:text-base md:mt-8 md:mb-4 leading-tight">{design.description}</p>
                    ...
                    <p className="hidden md:text text-left text-base">Details <br /></p>
                    <ul className="hidden md:text text-left text-base list-disc pl-4">
